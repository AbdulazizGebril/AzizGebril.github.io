...
// Code tweaked to adjust the racing bar chart in Migration Origins tab
...
var svg = d3.select("#chart-area").append("svg")
 ...
 // Start year 1990
    ...
    // import Origin_Racing.csv and make sure to deal with null values.
    // Define random colors for bars
    d3.csv('./Data/Origin_Racing.csv').then(function(data) {
    //if (error) throw error;
     ...
     // year snapshot: filter data for the year, sort the based on number of Immigrants ("value") then pick the top 10 migration origincountries
